...
renamed as (
    select
        ...
        case park_id
            ...
            when 'eb3f4560-2383-4a36-9152-6b3e5ed6bc57' then 'Universal Studios Florida'
            when '267615cc-8943-4c2a-ae2c-5da728ca591f' then 'Islands of Adventure'
            when '12dbb85b-265f-44e6-bccf-f1faa17211fc' then 'Epic Universe'
        end as park_name,
